...
(function (global, factory) {
	...
	***************************************************************************** */
	...
	function initialize(param) {
	    ...
	    var handleTouchStartEvent = function (event) {
	        var touches = event.changedTouches;
	        var rect = element.getBoundingClientRect();
	        for (var i = 0; i < touches.length; i++) {
	            var x = (touches[i].clientX - rect.left) / getScaleX();
	            var y = (touches[i].clientY - rect.top) / getScaleY();
	    ...
	    var handleTouchMoveEvent = function (event) {
	        var touches = event.changedTouches;
	        var rect = element.getBoundingClientRect();
	        for (var i = 0; i < touches.length; i++) {
	            var x = (touches[i].clientX - rect.left) / getScaleX();
	    ...
	    var handleTouchEndEvent = function (event) {
	        var touches = event.changedTouches;
	        var rect = element.getBoundingClientRect();
	        for (var i = 0; i < touches.length; i++) {
	            var x = (touches[i].clientX - rect.left) / getScaleX();
